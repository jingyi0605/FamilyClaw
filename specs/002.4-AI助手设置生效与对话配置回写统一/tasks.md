...
- [x] 2.1 统一“可对话 Agent”判定和默认 Agent 解析
  - 状态：DONE
...
- [x] 2.2 把 `ask / notify / auto` 的语义真正拆开
  - 状态：DONE
...
- [x] 3.3 让成员互动设置只保留真正会影响 Prompt 的字段
  - 状态：DONE
