...
- [ ] 1.3 建聊天实时事件通道或等价流式返回
  - 状态：未开始
  - 这一步到底做什么：把助手回复改成可持续接收的过程，而不是前端 8 秒后自己断气。
  - 做完以后能看到什么结果：聊天页能看到“发送中”“逐步出字”“完成”或“真实错误”。
  - 这一步依赖什么：1.2
  - 开始前先看：
    - `design.md` §4.3、§6.2
...
- [ ] 3.1 把 `memory_extraction` 接到聊天回合后处理
  - 状态：未开始
