...
- [x] 3.2 把网关 discovery 上报改接到正式 discovery 数据源
  - 状态：DONE
...
- [x] 3.3 让小爱插件 connector 提供候选设备与正式绑定结果
  - 状态：DONE
...
- [x] 4.1 让小爱设备控制只认正式 `plugin_id` 路由
  - 状态：DONE
...
- [x] 4.2 复用平台 speaker 与声纹能力，不复制逻辑
  - 状态：DONE
...
- [x] 5.1 删除旧 discovery / claim / 前端旧 API 入口
  - 状态：DONE
