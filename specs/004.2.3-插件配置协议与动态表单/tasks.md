...
- [x] 1.2 定义字段类型、UI widget 和 secret 语义
  - 状态：DONE
...
- [x] 5.2 补迁移说明和联调清单
  ...
  - `2026-03-16` 补充说明：已同步更新开发者手册和关联 Spec，包括 `004.2`、`004.3`、`004.4`、`010`，统一改成“稳定规范 + 高频变化引用”的维护方式。
