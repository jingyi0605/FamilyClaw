...
export const userAppThemeFoundation = {
  ...
  radiusLg: '14px',
  radiusXl: '20px',
  // H5 下字体 token 必须维持固定 px 语义，不能再让 rem 根字号放大。
  fontSizeXs: '12px',
  fontSizeSm: '13px',
  fontSizeMd: '15px',
  fontSizeLg: '18px',
...
export const userAppThemes: Record<ThemeId, UserAppTheme> = {
  'chun-he-jing-ming': {
...
export const userAppThemeList: UserAppTheme[] = Object.values(userAppThemes);
