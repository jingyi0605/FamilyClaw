...
@router.post("/{household_id}/plugins/{plugin_id}/config/preview", response_model=PluginConfigFormRead)
def preview_household_plugin_config_form_endpoint(
    household_id: str,
    plugin_id: str,
    ...
    ensure_actor_can_access_household(actor, household_id)
    try:
        result = preview_plugin_config_form(
            db,
            household_id=household_id,
            plugin_id=plugin_id,
            payload=payload,
