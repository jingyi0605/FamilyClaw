...
class WeatherEntityCopyTests(unittest.TestCase):
    ...
    def test_weather_plugin_refresh_writes_canonical_entities(self) -> None:
        ...
        self.assertEqual("23.5", entity_map["weather.temperature"].state_display)
        self.assertEqual("68", entity_map["weather.humidity"].state_display)
        self.assertEqual("4.2", entity_map["weather.wind_speed"].state_display)
        self.assertEqual("95", entity_map["weather.wind_direction"].state_display)
        self.assertEqual("1010", entity_map["weather.pressure"].state_display)
        self.assertEqual("80", entity_map["weather.cloud_cover"].state_display)
        self.assertEqual("0", entity_map["weather.precipitation_next_1h"].state_display)
