...
const SHELL_MESSAGES = {
  'zh-CN': {
    ...
    'settings.nav.language.label': '语言',
    'settings.nav.language.desc': '调整界面语言和时区',
    'settings.nav.notifications.label': '通知',
    'settings.nav.notifications.desc': '设置提醒方式和免打扰时段',
    'settings.nav.integrations.label': '设备',
          'settings.nav.integrations.desc': '管理设备与插件同步',
    'settings.nav.channelAccess.label': '消息平台',
    ...
    'userGuide.assistant.title': '对话入口在这里，这也是你和系统沟通的主要方式',
    'userGuide.assistant.content': '以后无论是提问、确认任务、继续追问，还是让家庭助手帮你处理事情，基本都会从这里进入，所以先记住它的位置。',
  ...
  'en-US': {
    ...
    'settings.nav.language.label': 'Language',
    ...
    'settings.nav.integrations.label': 'Devices',
          'settings.nav.integrations.desc': 'Manage device and plugin sync',
    'settings.nav.channelAccess.label': 'Messaging Platforms',
    ...
    'userGuide.assistant.title': 'Chat starts here, and this is your main way to talk to the system',
    'userGuide.assistant.content': 'This is where you will usually ask questions, confirm tasks, follow up on requests, and let the household assistant help you get things done, so it is worth remembering now.',
